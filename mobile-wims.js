    ...
    slots.forEach(function(slot){
      ...
      slot.innerHTML=
        '<div style="border:1.5px solid #bfe6d5;background:#f6fcf9;border-radius:14px;padding:12px;margin-top:10px">'+
          ...
          '<div class="field"><label>IPTV box</label><select data-wf="iptv" data-j="'+jid+'">'+opt(iptv,s.iptv)+'</select></div>'+
          '<label style="display:flex;align-items:center;gap:8px;font-size:12px;margin:6px 0 8px"><input type="checkbox" data-wf="kit" data-j="'+jid+'"'+(s.kit?' checked':'')+'> 1 standard kit used</label>'+
